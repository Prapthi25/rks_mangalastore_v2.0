...
import Kurloncataloguepage from "./Kurloncataloguepage"; // adjust path to your catalogue file
...
export default function KurlonCatalogueModal({ isOpen, onClose }: Props) {
